...
export const ProPill = styled(
  inject("uiStore")((p: { uiStore?: UiStore; className?: string }) => (
    <Pill className={p.className} color={p.uiStore!.theme.popColor}>
      PRO
    </Pill>
  ))
)`
...
export const CardSalesPitch = inject("accountStore")(
  observer(
    (p: {
